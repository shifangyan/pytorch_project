...
weight_path = "./weight/InceptionV3_500.weight" 
...
class ModelTest(object):
    ...
    def ModelInitialization(self,model_function,weight_path = None,last_liner_name = "classifier_liner",num_classes = 2):
        if weight_path is None:
            print "please give weight_path"
            exit()
        self.model = model_function(True,weight_path,last_liner_name,num_classes)
        if self.use_gpu:
...
if __name__ == "__main__":
    ...
    model_test.ModelInitialization(model_function,weight_path = weight_path,last_liner_name = "wearing_glasses",num_classes = 2)
