...
class ModelTrain(object):
    ...
    def ModelInitialization(self,model_function,fine_tuning,weight_path = None,last_liner_name = "classifier_liner",
        ...
        self.model = model_function(fine_tuning,weight_path,last_liner_name,num_classes,bn)
...
if __name__ == "__main__":
    ...
    model_train.ModelInitialization(model_function,fine_tuning=False,weight_path = None,last_liner_name = "wearing_glasses",num_classes = 2,bn = True)
