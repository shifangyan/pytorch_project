...
class Crawler:
    ...
    def start(self, word, spider_page_num=1, start_page=1):
        ...
        :return:
        """
        self.__start_amount = (start_page - 1) * 100
        self.__amount = spider_page_num * 100 + self.__start_amount
        self.get_images(word)

 
if __name__ == '__main__':
    crawler = Crawler(0.001)  # 抓取延迟为 0.05
    # crawler.start('亲人', 10, 2)  # 抓取关键词为 “亲人”，总数为 1 页（即总共 1*60=60 张），开始页码为 2
#《藏传佛教》《伊斯兰教》《基督教》
#喇嘛 觉姆 上师 堪布 活佛 仁波切 法王
#穆斯林 阿訇 毛拉 伊玛目 穆夫提 
#穆斯林祈祷  穆斯林不同头饰
#长老、执事、牧师、传道人、宣教士、同工、义工
    #crawler.start('戴帽子人脸图片', 100, 1)  # 抓取关键词为 “亲人 奶奶”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
    crawler.start('人脸', num_img)  # 抓取关键词为 “帅哥”，总数为 5 页（即总共 5*60=300 张）
